...
$(document).ready(function() {
       ...
       //petfinder API function
        function callPets(animal, location, breed){
            var petUrl = "http://api.petfinder.com/pet.find?format=json&key=0dbe85d873e32df55a5a7be564ae63a6&callback=?&animal="+animal+"&location="+location+"&breed="+breed+"&count=10";
            $.ajax({
            url: petUrl,
            dataType: 'jsonp',
            method: 'GET',
